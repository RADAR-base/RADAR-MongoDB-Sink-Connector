...
import org.radarcns.sink.mongodb.BatteryLevelRecordConverter;
...
public class BatteryLevelRecordConverterTest {
    ...
    public void supportedSchemaNames() {
        ...
        assertEquals("org.radarcns.key.MeasurementKey-org.radarcns.empatica.EmpaticaE4BatteryLevel",
                values.toArray()[0]);
    }
    ...
    public void convert() {
        ...
        Schema keySchema = SchemaBuilder.struct().field("userId", Schema.STRING_SCHEMA)
                .field("sourceId", Schema.STRING_SCHEMA).build();
        Struct keyStruct = new Struct(keySchema);
        keyStruct.put("userId", "user1");
        keyStruct.put("sourceId", "source1");

        Schema valueSchema = SchemaBuilder.struct().field("batteryLevel", Schema.FLOAT32_SCHEMA)
